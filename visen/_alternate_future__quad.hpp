...
struct StripQuad//X
{
    ...
    */
    ...
    static int get00Index() { return 0; };
    static int get01Index() { return 1; };
    static int get10Index() { return 2; };
    static int get11Index() { return 3; };
    ...
    */
    ...
    {
        v00.position.set(tx ,ty -hfrac);
        v01.position.set(tx ,ty);
        v11.position.set(tx +wfrac,ty);
        v10.position.set(tx +wfrac,ty -hfrac);
